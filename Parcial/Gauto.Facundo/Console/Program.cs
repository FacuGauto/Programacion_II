...
namespace Console
{
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            System.Console.WriteLine((string)equipo);
            
            if (Equipo.ValidarEquipo(equipo))
                System.Console.WriteLine("El equipo es válido");
            else
                System.Console.WriteLine("El equipo no es válido");
            ...
            equipo = equipo + j7;
            equipo = equipo + j8;
            System.Console.WriteLine("*******************************EQUIPO VÁLIDO*********************************");
            // Imprimo los datos del equipo
            System.Console.WriteLine((string)equipo);
            if (Equipo.ValidarEquipo(equipo))
                System.Console.WriteLine("El equipo es válido");
